...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { avatar: @tip.avatar, code: @tip.code, description: @tip.description, title: @tip.title, username: @tip.username }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { avatar: @tip.avatar, code: @tip.code, description: @tip.description, title: @tip.title, username: @tip.username }
    assert_redirected_to tip_path(assigns(:tip))
  end
